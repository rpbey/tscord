...
// `import()` ambient pattern volontaire pour expositions globales.
...
type LocalizationMap = Partial<
  Record<`${import("discord-api-types/v9").Locale | AdditionalLocaleString}`, string>
>;
...
type SlashChoiceOption = Modify<
  import("@rpbey/discordx").SlashChoiceType<string, string | number>,
  SanitizedOptions
>;

type ContextMenuOptionsX = Omit<
  import("@rpbey/discordx").ApplicationCommandOptions<
    import("@rpbey/discordx").NotEmpty<string>,
    string
  > & {
    type: Exclude<
