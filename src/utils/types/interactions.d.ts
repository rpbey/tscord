...
type EmittedInteractions = import('discord.js').CommandInteraction | import('@rpbey/discordx').SimpleCommandMessage | import('discord.js').ContextMenuCommandInteraction
...
type CommandCategory = import('@rpbey/discordx').DApplicationCommand & import('@rpbey/utilities').ICategory
